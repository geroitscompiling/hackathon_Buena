...
help:
	...
	@echo "  make run-history-live - replay day-01 to day-10 with live AI"
	@echo "  make run-history-mock - replay day-01 to day-10 with deterministic mocks"
...
run-history-live:
	HISTORY_MODE=live pnpm run dry-run:history

run-history-mock:
	HISTORY_MODE=mock pnpm run dry-run:history
